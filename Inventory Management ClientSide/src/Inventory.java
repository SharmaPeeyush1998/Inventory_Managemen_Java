...
public class Inventory implements Serializable {
	...
	public String toString() 
	{
		...
		return String.format(fmt, this.get_ID(),this.get_ItemName(),Double.toString(this.get_StartingQty()),
				Double.toString(this.get_QtyMinRestock()),Double.toString(get_QtySold()),Double.toString(get_QtyRestocked()),(new DecimalFormat("$##.##").format(get_UnitPrice())),
						Double.toString(get_QtyHand()),(new DecimalFormat("$##.##").format(get_Sales())));
	}
}
